...
public class SocialLoginChallengeHandler extends SecurityCheckChallengeHandler {
    ...
    private SocialAuthActivity mainActivity;

    public SocialLoginChallengeHandler(String securityCheck, SocialAuthActivity activity) {
        super(securityCheck);
    ...
    public void handleChallenge(JSONObject jsonObject) {
        mainActivity.runOnUiThread(new Runnable() {
            ...
            if (mainActivity.currentVendor == SocialAuthActivity.Vendor.GOOGLE) {
                mainActivity.signIn();
            }
            }
        });
